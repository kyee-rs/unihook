...
> {
    ...
    ): PrismaPromise<Prisma.JsonObject>;
...
export namespace Prisma {
     ...
     * If it's T[], return T
     */
    export type UnEnumerate<T extends unknown> = T extends Array<infer U> ? U
        : T;
  ...
  */
    ...
    type GetHavingFields<T> = {
        ...
        > extends True
            ...
            ? T[K] extends infer TK ? GetHavingFields<
                    UnEnumerate<TK> extends object ? Merge<UnEnumerate<TK>>
                        : never
                >
            : never
    ...
    export type HasReject<
        GlobalRejectSettings
            extends Prisma.PrismaClientOptions['rejectOnNotFound'],
        LocalRejectSettings,
    ...
    > = S extends { select: any; include: any }
        ...
        : S extends { select: any } & (UserCountOutputTypeArgs) ? {
                [P in TruthyKeys<S['select']>]: P extends
                    keyof UserCountOutputType ? UserCountOutputType[P] : never;
            }
        : UserCountOutputType;
    ...
    type GetPatternGroupByPayload<T extends PatternGroupByArgs> = PrismaPromise<
        Array<
            ...
            & {
                [P in ((keyof T) & (keyof PatternGroupByOutputType))]: P extends
    ...
    export type PatternGetPayload<
        S extends boolean | null | undefined | PatternArgs,
    > = S extends { select: any; include: any }
        ? 'Please either choose `select` or `include`'
        ...
        : S extends { select: any } & (PatternArgs | PatternFindManyArgs) ? {
                [P in TruthyKeys<S['select']>]: P extends 'User'
                    ...
                    : P extends keyof Pattern ? Pattern[P]
                    : never;
            }
        : Pattern;
    ...
    > {
         ...
         */
        findUnique<
            T extends PatternFindUniqueArgs,
        ...
        >(
            ...
            'findUnique',
            'Pattern'
        > extends True ? Prisma__PatternClient<PatternGetPayload<T>>
            : Prisma__PatternClient<PatternGetPayload<T> | null, null>;
         ...
         */
        findFirst<
            T extends PatternFindFirstArgs,
            LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
                ? T['rejectOnNotFound']
                : undefined,
        >(
        ...
        ): PrismaPromise<GetPatternAggregateType<T>>;
        ...
        >(
            args:
                & SubsetIntersection<T, PatternGroupByArgs, OrderByArg>
                & InputErrors,
        ): {} extends InputErrors ? GetPatternGroupByPayload<T>
     ...
     */
    export class Prisma__PatternClient<T, Null = never>
    ...
    export type PatternUpdateManyArgs = {
        ...
        data: XOR<
            ...
            PatternUncheckedUpdateManyInput
        >;
        /**
    ...
    > = S extends { select: any; include: any }
        ...
        : S extends { include: any } & (UserArgs | UserFindManyArgs) ? 
                & User
                & {
                    [P in TruthyKeys<S['include']>]: P extends 'patterns'
                        ? Array<PatternGetPayload<S['include'][P]>>
                        : P extends '_count'
                            ? UserCountOutputTypeGetPayload<S['include'][P]>
                        : never;
                }
        : S extends { select: any } & (UserArgs | UserFindManyArgs) ? {
                [P in TruthyKeys<S['select']>]: P extends 'patterns'
                    ? Array<PatternGetPayload<S['select'][P]>>
                    : P extends '_count'
    ...
    > {
        ...
        >(
            ...
            'findUnique',
            'User'
        > extends True ? Prisma__UserClient<UserGetPayload<T>>
        ...
        >(
            args:
                & SubsetIntersection<T, UserGroupByArgs, OrderByArg>
                & InputErrors,
    ...
    export class Prisma__UserClient<T, Null = never>
        ...
        patterns<T extends UserPatternsArgs = {}>(
            args?: Subset<T, UserPatternsArgs>,
        ): PrismaPromise<Array<PatternGetPayload<T>> | Null>;
    ...
    export type PatternCreateNestedManyWithoutUserInput = {
        create?: XOR<
            Enumerable<PatternCreateWithoutUserInput>,
            Enumerable<PatternUncheckedCreateWithoutUserInput>
        >;
    ...
    export type PatternCreateOrConnectWithoutUserInput = {
        where: PatternWhereUniqueInput;
        create: XOR<
            PatternCreateWithoutUserInput,
            PatternUncheckedCreateWithoutUserInput
        >;
    };
    ...
    export type PatternUpsertWithWhereUniqueWithoutUserInput = {
        where: PatternWhereUniqueInput;
        update: XOR<
            PatternUpdateWithoutUserInput,
            PatternUncheckedUpdateWithoutUserInput
        >;
        create: XOR<
            PatternCreateWithoutUserInput,
            PatternUncheckedCreateWithoutUserInput
    ...
    export type PatternUpdateManyWithWhereWithoutUserInput = {
        ...
        data: XOR<
            PatternUpdateManyMutationInput,
            PatternUncheckedUpdateManyWithoutPatternsInput
        >;
    };
